#import "PluginStatusbarPlugin.h"
#define ANDROID_COLOR(c) [UIColor colorWithRed:((c>>16)&0xFF)/255.0 green:((c>>8)&0xFF)/255.0 blue:((c)&0xFF)/255.0  alpha:((c>>24)&0xFF)/255.0]

@implementation PluginStatusbarPlugin

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"plugin.statusbar.com/statusbar"
            binaryMessenger:[registrar messenger]];
  PluginStatusbarPlugin* instance = [[PluginStatusbarPlugin alloc] init];
  [registrar addMethodCallDelegate:instance channel:channel];
}

static NSInteger statusBarViewTag = 48482454785;
